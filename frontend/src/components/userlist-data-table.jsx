    ...
    <div>
      <div className="flex items-center py-4">
        <input
          ...
          className="max-w-sm mt-1 mx-2 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-gray-500 focus:ring-gray-500 block w-full rounded-md sm:text-sm focus:ring-1"
        />

    ...
    <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
      ...
      <div className="flex flex-wrap items-center gap-4 mb-4">
        <input
          ...
          value={table.getColumn("nodeName")?.getFilterValue() ?? ""}
          onChange={(event) =>
            table.getColumn("nodeName")?.setFilterValue(event.target.value)
          }
          className="w-full sm:w-64 px-4 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-400"
        />
        <input
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              className="ml-auto bg-gray-100 hover:bg-gray-200 text-gray-800"
            >
              Columns
            </Button>
          </DropdownMenuTrigger>

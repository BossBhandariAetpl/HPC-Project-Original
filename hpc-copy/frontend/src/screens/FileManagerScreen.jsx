...
const FileManagerScreen = () => {
    ...
    const fetchFiles = async () => {
        try {
            const response = await axios.get(`http://localhost:8000/api/filemanagement/fetchdirectories/${username}`);
    ...
    const openUpdateFileDialog = async (filename) => {
        try {
            const response = await axios.get(`http://localhost:8000/api/filemanagement/filecontent/${username}/${filename}`);
    ...
    const deleteFile = async (filename) => {
        try {
            await axios.delete(`http://localhost:8000/api/filemanagement/deletefile/${username}/${filename}`);
